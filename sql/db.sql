...
(
  ...
  bus_empresa_id integer references empresa(empresa_id)
);
...
insert into  bus (bus_data,bus_empresa_id) values ('{"nombre":"CO-200","destino":"tarija","hora":"10:00","capacidad":"50"}',1);
